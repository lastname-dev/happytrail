<template>
  <div class="section section-javascript" id="javascriptComponents">
    <div class="container">
      ...
      <div class="row" id="modals">
        ...
        <div class="col-md-6 popover-buttons">
          <h4>Popovers</h4>
          <el-popover ref="popover1" popper-class="popover popover-primary" placement="left" width="200" trigger="click">
          ...
          <el-popover ref="popover2" popper-class="popover popover-success" placement="top-start" width="200"
            trigger="click">
          ...
          <el-popover ref="popover3" popper-class="popover popover-danger" placement="right" width="200" trigger="click">
          ...
          <el-popover ref="popover4" popper-class="popover" placement="bottom" width="200" trigger="click">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="datepicker-container">
                <fg-input>
                  <el-date-picker type="date" popper-class="date-picker date-picker-primary"
                    placeholder="Date Time Picker" v-model="pickers.datePicker">
                  </el-date-picker>
                </fg-input>
              </div>
            </div>
    ...
    <!-- small modal -->
    <modal :show.sync="modals.mini" class="modal-primary" :show-close="false" headerClasses="justify-content-center"
      type="mini">
